...
namespace Xamarin.Forms.Platform.iOS
{
	...
	public class TabletMasterDetailRenderer : UISplitViewController, IVisualElementRenderer, IEffectControlProvider
	{
		...
		void UpdateControllers()
		{
			...
			{
				var rrr = Platform.CreateRenderer(MasterDetailPage.Master);

				Platform.SetRenderer(MasterDetailPage.Master, rrr);
			}
			...
			var renderer = Platform.GetRenderer(MasterDetailPage.Master);

			var master = renderer.ViewController;
